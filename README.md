...
Considering data-driven personas tracked over 3 waves of survey data, does psychometric network analysis (PNA) reveal differences between their mental models of customer satisfaction?

**Q1:** For each survey wave, do the overall mental models differ?   
**Q2:** Within each survey wave, do the personas' mental models differ? If so, how?   
**Q3:** For each persona, do mental models differ across survey waves? If so, how?   

## Background Details: Personas, Mental Models, and Psychometric Network Analysis
